...
public class JwtAuthConverter implements Converter<Jwt, AbstractAuthenticationToken> {
    ...
    public AbstractAuthenticationToken convert(Jwt jwt) {
        Collection<GrantedAuthority> grantedAuthorities = new HashSet<>(extractResourceRoles(jwt));
        /// tokenda olmayan rolleri başka kaynaktan ekleyeceksek ////////
        //grantedAuthorities.add(new SimpleGrantedAuthority("ROLE_USER"));
        //grantedAuthorities.add(new SimpleGrantedAuthority("ROLE_ADMIN"));
        /////////////////////////////////////////////////////////////////
        Collection<GrantedAuthority> authorities =
                Stream.concat(jwtGrantedAuthoritiesConverter.convert(jwt).stream(), grantedAuthorities.stream()).collect(Collectors.toSet());
